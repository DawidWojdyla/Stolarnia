		...
		ajaxRequest.done(function (response){
			if(response != "Brak danych"){
				...
				if(parseInt(amounts.boardsAmount) >= <?=$_SESSION['boardsLimit']?>){
					...
					//document.getElementById('boardsAmount').style.backgroundColor  = "lightgreen";
				...
				if(parseInt(amounts.cuttingMetters) >= <?=$_SESSION['cuttingMettersLimit']?>){
					...
					//document.getElementById('cuttingMetters').style.backgroundColor  = "lightgreen";
				...
				if(parseInt(amounts.edgeBandingMetters) >= <?=$_SESSION['edgeBandingMettersLimit']?>){
					...
					//document.getElementById('edgeBandingMetters').style.backgroundColor  = "lightgreen";
