...
<div class="contentContainer noMargin">
	...
	<div style="border-top: 1px solid black; padding-left: 3px; padding-right: 3px; padding-top: 2px;" class="tabContainer">
		...
		<div class='btn btn-default btn-block boardTitle' id='board<?=$board -> boardId?>' onclick="showBoardDetails('<?=$board -> boardId?>')"><?=$board -> boardSign?><?=($board -> thickness + 0)?> - <?=$board -> boardSymbol?></div>
