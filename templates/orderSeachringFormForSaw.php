...
<form action="index.php?action=findTheOrder" name="orderSearchingForm" id="orderSearchingForm" method="post" autocomplete="off">
	<table class="table table-condensed">
		<tr>
			...
			<td>
				<div class="fullWidth">
					<select id='documentTypeSelect' class="form-control" style='max-width: 51px; display: inline; padding:2px;' name="documentType">
						<option value="PA"  
					...
					<input id='documentNumberInput' style='display: inline; width: 72px;' class="form-control" type="text" pattern="\d*" maxlength="6" name="documentNumber" value="<?=$documentNumber?>" required/>
