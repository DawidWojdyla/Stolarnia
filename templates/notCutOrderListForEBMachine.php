...
<div class="contentContainer noPadding noMargin">
	<div class="text-center header">Niepocięte zlecenia</div>
	<div class="table-responsive" style="border: none;"> 
		...
		<?PHP foreach($orderList as $order):?>
			<tr class="btn btn-default btn-block orderLink" style="display: table-row;"  id='<?=$order->orderId?>' onclick="showOrderDetails('<?=$order->orderId?>');">
				<td id="completionDate<?=$order->orderId?>"><?=$order -> completionDate?></td>
