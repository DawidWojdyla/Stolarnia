...
<div class="contentContainer">
	...
	<table class='table orderListTable'>
		<tr>
			<th>rodzaj</th><th>standardowa grubość</th><th>symbole</th><th>priorytet</th>
		</tr>
	<?PHP foreach($boardsSigns as $sign):?>
		<tr id='<?=$sign -> id?>' class="pointer" onclick="showOptions('<?=$sign -> id?>');">
			...
			<td><span id='symbol<?=$sign -> id?>'><?PHP if($sign -> noSymbolNeeded): ?><span class="glyphicon glyphicon-ban-circle"></span><?PHP else: ?><span class="glyphicon glyphicon-ok"></span><?PHP endif; ?></td>
